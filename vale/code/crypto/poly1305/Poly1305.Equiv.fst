...
unfold let iand #n = Types_s.iand #n
...
let lemma_poly1305_equiv_r (k:key) : Lemma
  ...
  let lowerUpper128_opaque = X64.Poly1305.Math.lowerUpper128_opaque in
  ...
  calc (==) {
    ...
    == {X64.Poly1305.Math.lemma_lowerUpper128_and v_lo_hi v_lo v_hi v_mask_0_1 v_mask0 v_mask1 z z0 z1}
    z;
    == {Opaque_s.reveal_opaque X64.Poly1305.Math.lowerUpper128}
    z1 * pow2 64 + z0;
    == {Arch.TypesNative.reveal_iand_all 64}
