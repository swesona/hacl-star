...
static void Hacl_Impl_Gen_p256_add(uint64_t *arg1, uint64_t *arg2, uint64_t *out)
{
  ...
  uint64_t cc = Hacl_Impl_Gen_add_carry((uint64_t)0U, a0, b0, r0);
  uint64_t cc1 = Hacl_Impl_Gen_add_carry(cc, a1, b1, r1);
  uint64_t cc2 = Hacl_Impl_Gen_add_carry(cc1, a2, b2, r2);
  uint64_t cc3 = Hacl_Impl_Gen_add_carry(cc2, a3, b3, r3);
  uint64_t t = cc3;
...
static void Hacl_Impl_Gen_p256_sub(uint64_t *arg1, uint64_t *arg2, uint64_t *out)
{
  ...
  uint64_t *r2 = out + (uint32_t)2U;
  uint64_t *r3 = out + (uint32_t)3U;
  uint64_t cc = Hacl_Impl_Gen_sub_borrow((uint64_t)0U, a0, b0, r0);
  uint64_t cc1 = Hacl_Impl_Gen_sub_borrow(cc, a1, b1, r1);
  uint64_t cc2 = Hacl_Impl_Gen_sub_borrow(cc1, a2, b2, r2);
  uint64_t cc3 = Hacl_Impl_Gen_sub_borrow(cc2, a3, b3, r3);
  uint64_t t = cc3;
...
{
  multByTwo(a, result);
  Hacl_Impl_Gen_p256_add(a, result, result);
}
...
static void multByMinusThree(uint64_t *a, uint64_t *result)
{
  ...
  Hacl_Impl_Gen_p256_sub(zeros, result, result);
}
