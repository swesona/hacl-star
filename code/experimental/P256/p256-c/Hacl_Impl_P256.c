...
static void Hacl_Impl_Gen_p256_double(uint64_t *arg1, uint64_t *out)
{
  ...
  uint64_t *r20 = out + (uint32_t)2U;
  uint64_t *r30 = out + (uint32_t)3U;
  uint64_t cc0 = Hacl_Impl_Gen_add_carry((uint64_t)0U, arg1[0U], arg1[0U], r00);
  uint64_t cc1 = Hacl_Impl_Gen_add_carry(cc0, arg1[1U], arg1[1U], r10);
...
)
{
  ...
  uint64_t *t2_b = tempBuffer + (uint32_t)2U;
  uint64_t *t3_b = tempBuffer + (uint32_t)3U;
  uint64_t *temp_zl1 = tempBufferLocal;
  uint64_t t0 = tempBuffer[0U];
  uint64_t t1 = tempBuffer[1U];
  uint64_t t2 = tempBuffer[2U];
  uint64_t t3 = tempBuffer[3U];
  uint64_t *t0_b1 = tempBuffer;
  uint64_t *t1_b1 = tempBuffer + (uint32_t)1U;
  uint64_t *t2_b1 = tempBuffer + (uint32_t)2U;
  uint64_t *t3_b1 = tempBuffer + (uint32_t)3U;
  uint128_t res0 = (uint128_t)x * b[0U];
  uint64_t zl0 = (uint64_t)res0;
  uint64_t zh0 = (uint64_t)(res0 >> (uint32_t)64U);
  uint64_t k0 = Hacl_Impl_Gen_add_carry((uint64_t)0U, zl0, t0, temp_zl1);
  uint64_t c = Hacl_Impl_Gen_add_carry(k0, zh0, (uint64_t)0U, t0_b1);
  uint64_t f = temp_zl1[0U];
  uint64_t *temp_zl2 = tempBufferLocal;
  uint64_t *temp_zh10 = tempBufferLocal + (uint32_t)1U;
  uint128_t res1 = (uint128_t)x * b[1U];
  uint64_t zl1 = (uint64_t)res1;
  uint64_t zh1 = (uint64_t)(res1 >> (uint32_t)64U);
  uint64_t k1 = Hacl_Impl_Gen_add_carry((uint64_t)0U, zl1, t0_b1[0U], temp_zl2);
  uint64_t uu____0 = Hacl_Impl_Gen_add_carry(k1, zh1, (uint64_t)0U, temp_zh10);
  uint64_t uu____1 = temp_zh10[0U];
  uint64_t k2 = Hacl_Impl_Gen_add_carry((uint64_t)0U, temp_zl2[0U], t1, t0_b1);
  uint64_t uu____2 = Hacl_Impl_Gen_add_carry(k2, uu____1, (uint64_t)0U, t1_b1);
  uint64_t *temp_zl20 = tempBufferLocal;
  uint64_t *temp_zh11 = tempBufferLocal + (uint32_t)1U;
  uint128_t res2 = (uint128_t)x * b[2U];
  uint64_t zl2 = (uint64_t)res2;
  uint64_t zh2 = (uint64_t)(res2 >> (uint32_t)64U);
  uint64_t k3 = Hacl_Impl_Gen_add_carry((uint64_t)0U, zl2, t1_b1[0U], temp_zl20);
  uint64_t uu____3 = Hacl_Impl_Gen_add_carry(k3, zh2, (uint64_t)0U, temp_zh11);
  uint64_t uu____4 = temp_zh11[0U];
  uint64_t k4 = Hacl_Impl_Gen_add_carry((uint64_t)0U, temp_zl20[0U], t2, t1_b1);
  uint64_t uu____5 = Hacl_Impl_Gen_add_carry(k4, uu____4, (uint64_t)0U, t2_b1);
  uint64_t *temp_zl21 = tempBufferLocal;
  uint64_t *temp_zh1 = tempBufferLocal + (uint32_t)1U;
  uint128_t res = (uint128_t)x * b[3U];
  uint64_t zl = (uint64_t)res;
  uint64_t zh = (uint64_t)(res >> (uint32_t)64U);
  uint64_t k5 = Hacl_Impl_Gen_add_carry((uint64_t)0U, zl, t2_b1[0U], temp_zl21);
  uint64_t uu____6 = Hacl_Impl_Gen_add_carry(k5, zh, (uint64_t)0U, temp_zh1);
  uint64_t uu____7 = temp_zh1[0U];
  uint64_t k6 = Hacl_Impl_Gen_add_carry((uint64_t)0U, temp_zl21[0U], t3, t2_b1);
  uint64_t uu____8 = Hacl_Impl_Gen_add_carry(k6, uu____7, (uint64_t)0U, t3_b1);
  uint64_t t410 = Hacl_Impl_Gen_add_carry((uint64_t)0U, t3_b1[0U], t4, t3_b1);
  tempBufferLocal[0U] = t410;
  uint64_t f0 = f;
  uint64_t t41 = tempBufferLocal[0U];
  uint64_t k = Hacl_Impl_Gen_add_carry((uint64_t)0U, t0_b[0U], f0 << (uint32_t)32U, t0_b);
  uint64_t k10 = Hacl_Impl_Gen_add_carry(k, t1_b[0U], f0 >> (uint32_t)32U, t1_b);
  uint64_t m = Hacl_Impl_Gen_sub_borrow((uint64_t)0U, f0, f0 << (uint32_t)32U, temp_zl);
  uint64_t uu____9 = Hacl_Impl_Gen_sub_borrow(m, f0, f0 >> (uint32_t)32U, temp_zh);
  uint64_t k20 = Hacl_Impl_Gen_add_carry(k10, t2_b[0U], temp_zl[0U], t2_b);
  uint64_t k30 = Hacl_Impl_Gen_add_carry(k20, t3_b[0U], temp_zh[0U], t3_b);
  uint64_t uu____10 = Hacl_Impl_Gen_add_carry(k30, t41, (uint64_t)0U, temp_zl);
  uint64_t t42 = temp_zl[0U];
  return t42;
}
