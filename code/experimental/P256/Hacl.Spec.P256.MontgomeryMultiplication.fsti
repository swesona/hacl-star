...
noextract 
val felem_add_seq: a: felem_seq_prime -> b: felem_seq_prime -> 
  Tot (r: felem_seq_prime {felem_seq_as_nat r = toDomain_ ((fromDomain_ (felem_seq_as_nat a) + fromDomain_ (felem_seq_as_nat b)) % prime)})

noextract
val felem_sub_seq: a: felem_seq_prime{felem_seq_as_nat a < prime} -> b: felem_seq_prime{felem_seq_as_nat b < prime} -> 
  Tot (r: felem_seq_prime {felem_seq_as_nat r < prime /\ 
  felem_seq_as_nat r = toDomain_ ((fromDomain_ (felem_seq_as_nat a) - fromDomain_(felem_seq_as_nat b))% prime)})


noextract
val montgomery_multiplication_seq: a: felem_seq_prime {felem_seq_as_nat a < prime} -> b: felem_seq_prime {felem_seq_as_nat b < prime} -> Tot (r: felem_seq_prime {felem_seq_as_nat r < prime /\ 
  felem_seq_as_nat r = toDomain_ (fromDomain_ (felem_seq_as_nat a) * fromDomain_(felem_seq_as_nat b) % prime)
  }) 
...
noextract
val mm_cube_seq: a: felem_seq_prime-> 
  Tot (r: felem_seq_prime {felem_seq_as_nat r = toDomain_ (fromDomain_ (felem_seq_as_nat a) * fromDomain_ (felem_seq_as_nat a) * fromDomain_ (felem_seq_as_nat a) % prime) })

noextract
val mm_quatre_seq: a: felem_seq_prime-> 
  Tot (r: felem_seq_prime {
...
noextract 
val mm_byTwo_seq: a: felem_seq_prime -> Tot (r: felem_seq_prime {
  felem_seq_as_nat r = toDomain_ (2 * fromDomain_ (felem_seq_as_nat a) % prime)})

noextract 
val mm_byThree_seq: a: felem_seq_prime  -> Tot (r: felem_seq_prime {
  felem_seq_as_nat r = toDomain_ (3 * fromDomain_ (felem_seq_as_nat a) % prime )})

noextract 
val mm_byFour_seq: a: felem_seq_prime  -> Tot (r: felem_seq_prime {
  felem_seq_as_nat r = toDomain_ (4 * fromDomain_ (felem_seq_as_nat a) % prime)})

noextract 
val mm_byEight_seq: a: felem_seq_prime -> Tot (r: felem_seq_prime {
  felem_seq_as_nat r = toDomain_ (8 * fromDomain_ (felem_seq_as_nat a) % prime)})

noextract 
val mm_byMinusThree_seq: a: felem_seq_prime -> Tot (r: felem_seq_prime {
  felem_seq_as_nat r = toDomain_ ((-3) * fromDomain_ (felem_seq_as_nat a) % prime)})
