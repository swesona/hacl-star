...
let rounds st =
  let h0 = ST.get () in
  Loop.eq_repeat0 #Spec.state 10 Spec.double_round (as_seq h0 st);
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 0;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 1;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 2;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 3;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 4;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 5;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 6;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 7;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 8;
  Loop.unfold_repeat 10 10 Spec.double_round (as_seq h0 st) 9;
  double_round st;
  double_round st;
  double_round st;
  double_round st;
