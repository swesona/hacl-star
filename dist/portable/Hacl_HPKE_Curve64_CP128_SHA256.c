...
)
{
  ...
  *infolen_b =
    context
    + (uint32_t)7U + (uint32_t)32U + (uint32_t)32U + (uint32_t)32U + (uint32_t)1U + (uint32_t)32U;
  infolen_b[0U] = (uint8_t)32U;
  uint8_t
  *output_info =
    context
    + (uint32_t)7U + (uint32_t)32U + (uint32_t)32U + (uint32_t)32U + (uint32_t)2U + (uint32_t)32U;
