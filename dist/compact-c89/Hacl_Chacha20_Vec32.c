...
)
{
  ...
  {
    uint32_t rem1 = len % ((uint32_t)1U * (uint32_t)64U);
    uint32_t nb = len / ((uint32_t)1U * (uint32_t)64U);
    uint32_t rem2 = len % ((uint32_t)1U * (uint32_t)64U);
    {
      uint32_t i0;
      for (i0 = (uint32_t)0U; i0 < nb; i0 = i0 + (uint32_t)1U)
      {
        uint8_t *uu____0 = out + i0 * (uint32_t)1U * (uint32_t)64U;
        ...
        Hacl_Chacha20_Vec32_chacha20_core_32(k, ctx, i0);
        {
          uint32_t bl[16U] = { 0U };
          {
            ...
            {
              uint32_t *os = bl;
              uint32_t u = load32_le(uu____1 + i * (uint32_t)1U * (uint32_t)4U);
              uint32_t x = u;
              os[i] = x;
            }
          }
    ...
    if (rem2 > (uint32_t)0U)
    {
      uint8_t *uu____2 = out + nb * (uint32_t)1U * (uint32_t)64U;
      uint8_t *uu____3 = text + nb * (uint32_t)1U * (uint32_t)64U;
      ...
      memcpy(plain, uu____3, rem1 * sizeof uu____3[0U]);
      {
        ...
        Hacl_Chacha20_Vec32_chacha20_core_32(k, ctx, nb);
        {
          uint32_t bl[16U] = { 0U };
          {
            ...
            {
              uint32_t *os = bl;
              uint32_t u = load32_le(plain + i * (uint32_t)1U * (uint32_t)4U);
              uint32_t x = u;
              os[i] = x;
            }
          }
...
)
{
  ...
  Hacl_Chacha20_Vec32_chacha20_init_32(ctx, key, n1, ctr);
  {
    ...
    {
      uint8_t *uu____2 = out + nb * (uint32_t)1U * (uint32_t)64U;
      uint8_t *uu____3 = cipher + nb * (uint32_t)1U * (uint32_t)64U;
      uint8_t plain[64U] = { 0U };
      memcpy(plain, uu____3, rem1 * sizeof uu____3[0U]);
      {
        uint32_t k[16U] = { 0U };
