...
)
{
  ...
  Hacl_Curve25519_64_scalarmult(zz, skE, pkR);
  {
      ...
      memset(context, 0U, context_len * sizeof context[0U]);
      {
        ...
        KRML_CHECK_SIZE(sizeof (uint8_t), (uint32_t)10U + context_len);
        {
          ...
          memset(tmp, 0U, ((uint32_t)10U + context_len) * sizeof tmp[0U]);
          {
            ...
            uu____0[0U] = (uint8_t)7U;
            uu____0[1U] = (uint8_t)7U;
            uu____0[2U] = (uint8_t)7U;
            uu____0[3U] = (uint8_t)7U;
            uu____0[4U] = (uint8_t)7U;
            uu____0[5U] = (uint8_t)7U;
...
)
{
  ...
  Hacl_Curve25519_64_scalarmult(zz, skR, pkE);
  {
    uint8_t default_psk1[64U] = { 0U };
    uint8_t default_pkI1[32U] = { 0U };
    uint32_t
...
)
{
  ...
  uint8_t *pkE;
  uint8_t *dec;
  Hacl_Curve25519_64_secret_to_public(pkR_, skE);
  Hacl_Curve25519_64_scalarmult(zz, skE, pkR);
  pkE = output;
  Hacl_HPKE_Curve64_CP128_SHA512_setupBaseI(pkE, k1, n1, skE, pkR_, infolen, info);
  dec = output + (uint32_t)32U;
  Hacl_Chacha20Poly1305_128_aead_encrypt(k1, n1, infolen, info, mlen, m, dec, dec + mlen);
}
...
)
{
  ...
  uint32_t z;
  Hacl_Curve25519_64_scalarmult(zz, skR, pkE1);
  Hacl_HPKE_Curve64_CP128_SHA512_setupBaseR(k1, n1, pkE1, skR, infolen, info);
  z =
    Hacl_Chacha20Poly1305_128_aead_decrypt(k1,
      n1,
      infolen,
      info,
      clen - (uint32_t)16U,
