...
)
{
  ...
  uint8_t *pkE;
  uint8_t *dec;
  Hacl_Curve25519_51_secret_to_public(pkR_, skE);
  Hacl_Curve25519_51_scalarmult(zz, skE, pkR);
  pkE = output;
  Hacl_HPKE_Curve51_CP128_SHA512_setupBaseI(pkE, k1, n1, skE, pkR_, infolen, info);
...
)
{
  ...
  uint32_t z;
  Hacl_Curve25519_51_scalarmult(zz, skR, pkE1);
  Hacl_HPKE_Curve51_CP128_SHA512_setupBaseR(k1, n1, pkE1, skR, infolen, info);
  z =
