/* 
  ...
  KreMLin invocation: /home/aymeric/These/workspaces/2/everest/kremlin/krml -verbose -verbose -I /home/aymeric/These/workspaces/2/everest/hacl-star/code/old/lib/kremlin -I /home/aymeric/These/workspaces/2/everest/kremlin/kremlib/compat -I /home/aymeric/These/workspaces/2/everest/hacl-star/specs -I /home/aymeric/These/workspaces/2/everest/hacl-star/specs/old -I . -fparentheses -fcurly-braces -fno-shadow -ccopt -march=native -verbose -ldopt -flto -bundle Crypto.Symmetric.AES+Crypto.Symmetric.AES128=*[rename=Hacl_AES] -tmpdir aesgcm-c89 -fc89 -minimal -add-include "kremlib.h" -skip-compilation aesgcm-c/out.krml
  F* version: 182fa4da
...
Crypto_Symmetric_AES_keyExpansion_aux_0(uint8_t *w, uint8_t *temp, uint8_t *sbox, uint32_t j)
{
  ...
  if (j % (uint32_t)8U == (uint32_t)0U)
  {
    ...
    t0 = temp[0U];
    rc = Crypto_Symmetric_AES_rcon(j / (uint32_t)8U, (uint8_t)1U);
    z = t0 ^ rc;
    temp[0U] = z;
  }
...
)
{
  ...
  if (j % (uint32_t)4U == (uint32_t)0U)
  {
    ...
    t0 = temp[0U];
    rc = Crypto_Symmetric_AES128_rcon(j / (uint32_t)4U, (uint8_t)1U);
    z = t0 ^ rc;
    temp[0U] = z;
  }
