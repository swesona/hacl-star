...
static void Hacl_Impl_QTesla_Gauss_cSHAKE_sampk(int64_t *sampk, uint16_t nonce, uint8_t *seed)
{
  ...
  uint8_t
  *sampk_binary =
    alloca(((uint32_t)512U + (uint32_t)209U) * (uint32_t)1U * (uint32_t)8U * sizeof (uint8_t));
  memset(sampk_binary,
    0U,
...
static void Hacl_Impl_QTesla_Gauss_kmxGauss(int32_t *z, uint8_t *seed, uint32_t nonce)
{
  ...
  int64_t *sampk = alloca(((uint32_t)512U + (uint32_t)209U) * (uint32_t)1U * sizeof (int64_t));
  ...
  int32_t *sampg = alloca(((uint32_t)512U + (uint32_t)209U) * sizeof (int32_t));
...
void Hacl_Impl_QTesla_poly_uniform(int32_t *a, uint8_t *seed)
{
  ...
  uint8_t *buf1 = alloca(((uint32_t)3192U + (uint32_t)1U) * sizeof (uint8_t));
...
int32_t Hacl_Impl_QTesla_qtesla_keygen(uint8_t *pk, uint8_t *sk)
{
  ...
  uint8_t
  *randomness_extended = alloca(((uint32_t)1U + (uint32_t)3U) * (uint32_t)32U * sizeof (uint8_t));
...
void Hacl_Impl_QTesla_hash_H(uint8_t *c_bin, int32_t *v_, uint8_t *hm)
{
  ...
  uint8_t *t = alloca(((uint32_t)512U + (uint32_t)64U) * sizeof (uint8_t));
...
)
{
  ...
  uint8_t
  *randomness_input = alloca(((uint32_t)32U + (uint32_t)32U + (uint32_t)64U) * sizeof (uint8_t));
