...
insert_(
  uint32_t lv0,
  uint32_t j10,
  LowStar_Vector_vector_str__LowStar_Vector_vector_str__uint8_t_ hs0,
  uint8_t *acc0
)
{
  uint32_t lv = lv0;
  uint32_t j1 = j10;
  LowStar_Vector_vector_str__LowStar_Vector_vector_str__uint8_t_ hs = hs0;
  uint8_t *acc = acc0;
  while (true)
  {
    LowStar_Vector_vector_str__uint8_t_
...
construct_rhs(
  uint32_t lv0,
  LowStar_Vector_vector_str__LowStar_Vector_vector_str__uint8_t_ hs0,
  LowStar_Vector_vector_str__uint8_t_ rhs0,
  uint32_t i10,
  uint32_t j10,
  uint8_t *acc0,
  bool actd0
)
{
  uint32_t lv = lv0;
  LowStar_Vector_vector_str__LowStar_Vector_vector_str__uint8_t_ hs = hs0;
  LowStar_Vector_vector_str__uint8_t_ rhs = rhs0;
  uint32_t i1 = i10;
  uint32_t j1 = j10;
  uint8_t *acc = acc0;
  bool actd = actd0;
